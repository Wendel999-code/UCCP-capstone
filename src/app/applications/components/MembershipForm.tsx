      ...
      <div className="max-w-2xl w-full space-y-8">
        <div className="rounded-lg border bg-white p-8 shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md border px-3 py-2 text-sm focus:ring-2 focus:ring-yellow-500"
                  placeholder="John"
                />
              </div>
            ...
            <div>
              <label htmlFor="church" className="block text-sm font-medium">
                Select Church
              </label>
              <Select
                value={churchId}
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-1 block w-full min-h-[100px] rounded-md border px-3 py-2 text-sm focus:ring-2 focus:ring-yellow-500"
                placeholder="Brgy, Municipality, Province, Zip Code"
              />
            </div>
